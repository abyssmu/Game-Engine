...
bool TextureShader::Initialize(
	...
	HWND& hwnd)
{
	auto vs = LPCWSTR(L"Main/WindowManager/System/Graphics/TextureShader/TextureShader_vs.hlsl");
	auto ps = LPCWSTR(L"Main/WindowManager/System/Graphics/TextureShader/TextureShader_ps.hlsl");
...
bool TextureShader::CompilerShaders(
	ID3D11Device* device,
	HWND& hwnd,
	LPCWSTR& vsFilename,
	LPCWSTR& psFilename)
...
bool TextureShader::CreateCameraCB(
	ID3D11Device* device)
{
...
bool TextureShader::CreateCameraDP(
	ID3D11DeviceContext* deviceContext,
	DirectX::XMFLOAT3& cameraPosition)
{
...
bool TextureShader::CreateLayout(
	ID3D11Device* device)
{
...
bool TextureShader::CreateLightCB(
	ID3D11Device* device)
{
...
bool TextureShader::CreateLightDP(
	ID3D11DeviceContext* deviceContext,
	DirectX::XMFLOAT4& ambientColor,
	DirectX::XMFLOAT4& diffuseColor,
	DirectX::XMFLOAT3& lightDirection,
...
bool TextureShader::CreateMatrixCB(
	ID3D11Device* device)
{
...
bool TextureShader::CreateMatrixDP(
	ID3D11DeviceContext* deviceContext,
	DirectX::XMMATRIX& worldMatrix,
	DirectX::XMMATRIX& viewMatrix,
	DirectX::XMMATRIX& projectionMatrix)
